      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-200">
            ...
            <a href={entryUrl} target="_blank" rel="noopener noreferrer" className="w-full bg-[#027a9c] hover:bg-[#026278] text-white font-bold py-4 px-6 rounded-xl transition-colors duration-300 flex items-center justify-center gap-2 text-lg">
              相談する
